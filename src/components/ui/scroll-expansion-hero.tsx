            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                        ...
                        src={
                          mediaSrc.includes('embed')
                            ...
                            : mediaSrc.replace('watch?v=', 'embed/') +
                              ...
                              (mediaSrc.split('v=')[1] || mediaSrc.split('/').pop())
                        }
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  ...
                  {scrollToExpand && (
                    <p
                      className='text-primary-light font-medium text-center'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-6xl font-bold text-white transition-none font-serif'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white transition-none font-serif'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
