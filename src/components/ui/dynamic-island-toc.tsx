    ...
    <>
      ...
      >
        <motion.div
          ...
          className="relative overflow-hidden border border-white/20 bg-ink/80 text-white shadow-[0_8px_32px_rgba(139,92,246,0.3)] backdrop-blur-xl"
        >
          {/* CLOSED PILL CONTENT */}
          <motion.div
            initial={false}
          ...
          >
            <div className="h-2 w-2 shrink-0 rounded-full bg-primary-light" />
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive && "bg-primary/30 font-medium text-white shadow-[0_0_15px_rgba(139,92,246,0.2)]",
                        !isActive && isHovered && "bg-white/10 opacity-100 text-white",
                        !isActive && !isHovered && "bg-transparent opacity-60 text-white/80",
                      )}
                    >
                      ...
                      <motion.div
                        ...
                        className="ml-3 h-1.5 w-1.5 shrink-0 rounded-full bg-primary-light"
                      />
                    </button>
                  );
                })}
